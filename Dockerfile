...
RUN apt-get update
RUN set -ex \
    && apt-get install -y libblas-dev liblapack-dev libatlas-base-dev gfortran libgdal-dev libpq-dev libfontconfig1-dev libxml2 libxslt1-dev libav-tools --no-install-recommends
