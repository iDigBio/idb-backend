...
acceptable_licenses_trans = {
    ...
    "https://creativecommons.org/publicdomain/zero/1.0": "CC0",
    "Attribution": "CC4 BY",
    "Attribution-NonCommercial": "CC4 BY-NC",
    "Creative Commons Attribution Australia 3.0": "CC3 BY",
    "Creative Commons Attribution-ShareAlike Australia 2.5": "CC4 BY-SA",
    "Creative Commons Attribution International 3.0": "CC3 BY",
    ...
    "Creative Commons Attribution (CC-BY) 4.0 License": "CC4 BY",
    "CC0": "CC0",
    ...
    "http://creativecommons.org/publicdomain/zero/1.0/ and http://vertnet.org/resources/norms.html": "CC0",
    "https://creativecommons.org/publicdomain/zero/1.0/ and http://www.vertnet.org/resources/norms.html": "CC0",
...
def pick_license(s, debug=False):
    ...
    rights_regex = re.compile(
        r"((?:by(?:.?nc)?(?:.?sa)?(?:.?nd)?)|cc0|zero|(?:public.?domain)).?(\d\.\d)?",
        re.I
    )
