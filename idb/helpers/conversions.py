...
fields = {
    "records": [
        ...
        ["lowestbiostratigraphiczone", "dwc:lowestBiostratigraphicZone", "text", 1, None],
        ["lithostratigraphicterms", "dwc:lithostratigraphicTerms", "text", 1, None],
        ["earliestperiodorlowestsystem","dwc:earliestPeriodOrLowestSystem","text", 1, None],
        ["earliesteraorlowesterathem", "dwc:earliestEraOrLowestErathem", "text", 1, None],
        ["earliestepochorlowestseries", "dwc:earliestEpochOrLowestSeries", "text", 1, None],
        ["earliestageorloweststage", "dwc:earliestAgeOrLowestStage", "text", 1, None],
        ["latesteraorhighesterathem", "dwc:latestEraOrHighestErathem", "text", 1, None],
        ["latestepochorhighestseries", "dwc:latestEpochOrHighestSeries", "text", 1, None],
        ["latestageorhigheststage", "dwc:latestAgeOrHighestStage", "text", 1, None],
        ["latestperiodorhighestsystem","dwc:latestPeriodOrHighestSystem","text", 1, None],
