...
sub_types = {
    ...
    "dcterms:bibliographicCitation": [None],
    "dcterms:references": [None],
    "dwc:institutionID": [None],
    "dwc:collectionID": [None],
    "dwc:datasetID": [None],
    "dwc:institutionCode": [None],
    "dwc:collectionCode": [None],
    "dwc:datasetName": [None],
    "dwc:ownerInstitutionCode": [None],
    "dwc:basisOfRecord": [None],
    "dwc:informationWithheld": [None],
    "dwc:dataGeneralizations": [None],
    "dwc:dynamicProperties": [None],
    "dwc:occurrenceID": [None],
    "dwc:catalogNumber": [None],
    "dwc:recordNumber": [None],
    "dwc:recordedBy": [None],
    "dwc:individualCount": [None],
    "dwc:organismQuantity": [None],
    "dwc:organismQuantityType": [None],
    "dwc:sex": [None],
    "dwc:lifeStage": [None],
    ...
    "dwc:disposition": [None],
    "dwc:associatedMedia": [None],
    "dwc:associatedReferences": [None],
    "dwc:associatedSequences": [None],
    "dwc:associatedTaxa": [None],
    "dwc:otherCatalogNumbers": [None],
