...
# "given field name" => ["canonical field name", "base type", "sub-type"]
translate_dict = {
    ...
    "dwc:dateIdentified": ["dwc:dateIdentified", "dwc:Occurrence"],
    ...
    "dwc:identifiedBy": ["dwc:identifiedBy", "dwc:Occurrence"],
    ...
    "dwc:lifeStage": ["dwc:lifeStage", "dwc:Occurrence"],
    ...
    "dwc:nameAccordingTo": ["dwc:nameAccordingTo", "dwc:Occurrence"],
    ...
    "dwc:preparations": ["dwc:preparations", "dwc:Occurrence"],
    ...
    "dwc:scientificName": ["dwc:scientificName", "dwc:Occurrence"],
    "dwc:scientificNameAuthorship": ["dwc:scientificNameAuthorship", "dwc:Occurrence"],
    "dwc:scientificNameID": ["dwc:scientificNameID", "dwc:Occurrence"],
    "dwc:sex": ["dwc:sex", "dwc:Occurrence"],
    ...
    "dwc:vernacularName": ["dwc:vernacularName", "dwc:Occurrence"],
...
sub_types = {
    "id": "dwc:Occurrence",
    "dc:rights": "dwc:Occurrence",
    "dcterms:type": "dwc:Occurrence",
    "dcterms:modified": "dwc:Occurrence",
    "dcterms:language": "dwc:Occurrence",
    "dcterms:license": "dwc:Occurrence",
    "dcterms:rightsHolder": "dwc:Occurrence",
    "dcterms:rights": "dwc:Occurrence",
    "dcterms:accessRights": "dwc:Occurrence",
    "dcterms:bibliographicCitation": "dwc:Occurrence",
    "dcterms:references": "dwc:Occurrence",
    "dwc:institutionID": "dwc:Occurrence",
    "dwc:collectionID": "dwc:Occurrence",
    "dwc:datasetID": "dwc:Occurrence",
    "dwc:institutionCode": "dwc:Occurrence",
    "dwc:collectionCode": "dwc:Occurrence",
    "dwc:datasetName": "dwc:Occurrence",
    "dwc:ownerInstitutionCode": "dwc:Occurrence",
    "dwc:basisOfRecord": "dwc:Occurrence",
    "dwc:informationWithheld": "dwc:Occurrence",
    "dwc:dataGeneralizations": "dwc:Occurrence",
    "dwc:dynamicProperties": "dwc:Occurrence",
    "dwc:occurrenceID": "dwc:Occurrence",
    "dwc:catalogNumber": "dwc:Occurrence",
    "dwc:recordNumber": "dwc:Occurrence",
    "dwc:recordedBy": "dwc:Occurrence",
    "dwc:individualCount": "dwc:Occurrence",
    "dwc:organismQuantity": "dwc:Occurrence",
    "dwc:organismQuantityType": "dwc:Occurrence",
    "dwc:sex": "dwc:Occurrence",
    "dwc:lifeStage": "dwc:Occurrence",
    "dwc:reproductiveCondition": "dwc:Occurrence",
    "dwc:behavior": "dwc:Occurrence",
    "dwc:establishmentMeans": "dwc:Occurrence",
    "dwc:occurrenceStatus": "dwc:Occurrence",
    "dwc:preparations": "dwc:Occurrence",
    "dwc:disposition": "dwc:Occurrence",
    "dwc:associatedMedia": "dwc:Occurrence",
    "dwc:associatedReferences": "dwc:Occurrence",
    "dwc:associatedSequences": "dwc:Occurrence",
    "dwc:associatedTaxa": "dwc:Occurrence",
    "dwc:otherCatalogNumbers": "dwc:Occurrence",
    "dwc:occurrenceRemarks": "dwc:Occurrence",
    "dwc:individualID": "dwc:Occurrence",
    "dwc:organismID": "dwc:Organism",
    "dwc:organismName": "dwc:Organism",
    "dwc:organismScope": "dwc:Organism",
    "dwc:associatedOccurrences": "dwc:Organism",
    "dwc:associatedOrganisms": "dwc:Organism",
    "dwc:previousIdentifications": "dwc:Organism",
    "dwc:organismRemarks": "dwc:Organism",
    "dwc:materialSampleID": "dwc:MaterialSample",
    "dwc:eventID": "dwc:Event",
    "dwc:parentEventID": "dwc:Event",
    "dwc:fieldNumber": "dwc:Event",
    "dwc:eventDate": "dwc:Event",
    "dwc:eventTime": "dwc:Event",
    "dwc:startDayOfYear": "dwc:Event",
    "dwc:endDayOfYear": "dwc:Event",
    "dwc:year": "dwc:Event",
    "dwc:month": "dwc:Event",
    "dwc:day": "dwc:Event",
    "dwc:verbatimEventDate": "dwc:Event",
    "dwc:habitat": "dwc:Event",
    "dwc:samplingProtocol": "dwc:Event",
    "dwc:sampleSizeValue": "dwc:Event",
    "dwc:sampleSizeUnit": "dwc:Event",
    "dwc:samplingEffort": "dwc:Event",
    "dwc:fieldNotes": "dwc:Event",
    "dwc:eventRemarks": "dwc:Event",
    "dwc:locationID": "dwc:Location",
    "dwc:higherGeographyID": "dwc:Location",
    "dwc:higherGeography": "dwc:Location",
    "dwc:continent": "dwc:Location",
    "dwc:waterBody": "dwc:Location",
    "dwc:islandGroup": "dwc:Location",
    "dwc:island": "dwc:Location",
    "dwc:country": "dwc:Location",
    "dwc:countryCode": "dwc:Location",
    "dwc:stateProvince": "dwc:Location",
    "dwc:county": "dwc:Location",
    "dwc:municipality": "dwc:Location",
    "dwc:locality": "dwc:Location",
    "dwc:verbatimLocality": "dwc:Location",
    "dwc:minimumElevationInMeters": "dwc:Location",
    "dwc:maximumElevationInMeters": "dwc:Location",
    "dwc:verbatimElevation": "dwc:Location",
    "dwc:minimumDepthInMeters": "dwc:Location",
    "dwc:maximumDepthInMeters": "dwc:Location",
    "dwc:verbatimDepth": "dwc:Location",
    "dwc:minimumDistanceAboveSurfaceInMeters": "dwc:Location",
    "dwc:maximumDistanceAboveSurfaceInMeters": "dwc:Location",
    "dwc:locationAccordingTo": "dwc:Location",
    "dwc:locationRemarks": "dwc:Location",
    "dwc:decimalLatitude": "dwc:Location",
    "dwc:decimalLongitude": "dwc:Location",
    "dwc:geodeticDatum": "dwc:Location",
    "dwc:coordinateUncertaintyInMeters": "dwc:Location",
    "dwc:coordinatePrecision": "dwc:Location",
    "dwc:pointRadiusSpatialFit": "dwc:Location",
    "dwc:verbatimCoordinates": "dwc:Location",
    "dwc:verbatimLatitude": "dwc:Location",
    "dwc:verbatimLongitude": "dwc:Location",
    "dwc:verbatimCoordinateSystem": "dwc:Location",
    "dwc:verbatimSRS": "dwc:Location",
    "dwc:footprintWKT": "dwc:Location",
    "dwc:footprintSRS": "dwc:Location",
    "dwc:footprintSpatialFit": "dwc:Location",
    "dwc:georeferencedBy": "dwc:Location",
    "dwc:georeferencedDate": "dwc:Location",
    "dwc:georeferenceProtocol": "dwc:Location",
    "dwc:georeferenceSources": "dwc:Location",
    "dwc:georeferenceVerificationStatus": "dwc:Location",
    "dwc:georeferenceRemarks": "dwc:Location",
    "dwc:geologicalContextID": "dwc:GeologicalContext",
    "dwc:earliestEonOrLowestEonothem": "dwc:GeologicalContext",
    "dwc:latestEonOrHighestEonothem": "dwc:GeologicalContext",
    "dwc:earliestEraOrLowestErathem": "dwc:GeologicalContext",
    "dwc:latestEraOrHighestErathem": "dwc:GeologicalContext",
    "dwc:earliestPeriodOrLowestSystem": "dwc:GeologicalContext",
    "dwc:latestPeriodOrHighestSystem": "dwc:GeologicalContext",
    "dwc:earliestEpochOrLowestSeries": "dwc:GeologicalContext",
    "dwc:latestEpochOrHighestSeries": "dwc:GeologicalContext",
    "dwc:earliestAgeOrLowestStage": "dwc:GeologicalContext",
    "dwc:latestAgeOrHighestStage": "dwc:GeologicalContext",
    "dwc:lowestBiostratigraphicZone": "dwc:GeologicalContext",
    "dwc:highestBiostratigraphicZone": "dwc:GeologicalContext",
    "dwc:lithostratigraphicTerms": "dwc:GeologicalContext",
    "dwc:group": "dwc:GeologicalContext",
    "dwc:formation": "dwc:GeologicalContext",
    "dwc:member": "dwc:GeologicalContext",
    "dwc:bed": "dwc:GeologicalContext",
    "dwc:identificationID": "dwc:Identification",
    "dwc:identificationQualifier": "dwc:Identification",
    "dwc:typeStatus": "dwc:Identification",
    "dwc:identifiedBy": "dwc:Identification",
    "dwc:dateIdentified": "dwc:Identification",
    "dwc:identificationReferences": "dwc:Identification",
    "dwc:identificationVerificationStatus": "dwc:Identification",
    "dwc:identificationRemarks": "dwc:Identification",
    "dwc:taxonID": "dwc:Taxon",
    "dwc:scientificNameID": "dwc:Taxon",
    "dwc:acceptedNameUsageID": "dwc:Taxon",
    "dwc:parentNameUsageID": "dwc:Taxon",
    "dwc:originalNameUsageID": "dwc:Taxon",
    "dwc:nameAccordingToID": "dwc:Taxon",
    "dwc:namePublishedInID": "dwc:Taxon",
    "dwc:taxonConceptID": "dwc:Taxon",
    "dwc:scientificName": "dwc:Taxon",
    "dwc:acceptedNameUsage": "dwc:Taxon",
    "dwc:parentNameUsage": "dwc:Taxon",
    "dwc:originalNameUsage": "dwc:Taxon",
    "dwc:nameAccordingTo": "dwc:Taxon",
    "dwc:namePublishedIn": "dwc:Taxon",
    "dwc:namePublishedInYear": "dwc:Taxon",
    "dwc:higherClassification": "dwc:Taxon",
    "dwc:kingdom": "dwc:Taxon",
    "dwc:phylum": "dwc:Taxon",
    "dwc:class": "dwc:Taxon",
    "dwc:order": "dwc:Taxon",
    "dwc:family": "dwc:Taxon",
    "dwc:genus": "dwc:Taxon",
    "dwc:subgenus": "dwc:Taxon",
    "dwc:specificEpithet": "dwc:Taxon",
    "dwc:infraspecificEpithet": "dwc:Taxon",
    "dwc:taxonRank": "dwc:Taxon",
    "dwc:verbatimTaxonRank": "dwc:Taxon",
    "dwc:scientificNameAuthorship": "dwc:Taxon",
    "dwc:vernacularName": "dwc:Taxon",
    "dwc:nomenclaturalCode": "dwc:Taxon",
    "dwc:taxonomicStatus": "dwc:Taxon",
    "dwc:nomenclaturalStatus": "dwc:Taxon",
    "dwc:taxonRemarks": "dwc:Taxon",
    "dwc:measurementID": "dwc:MeasurementOrFact",
    "dwc:measurementType": "dwc:MeasurementOrFact",
    "dwc:measurementValue": "dwc:MeasurementOrFact",
    "dwc:measurementAccuracy": "dwc:MeasurementOrFact",
    "dwc:measurementUnit": "dwc:MeasurementOrFact",
    "dwc:measurementDeterminedBy": "dwc:MeasurementOrFact",
    "dwc:measurementDeterminedDate": "dwc:MeasurementOrFact",
    "dwc:measurementMethod": "dwc:MeasurementOrFact",
    "dwc:measurementRemarks": "dwc:MeasurementOrFact",
    "dwc:resourceRelationshipID": "dwc:ResourceRelationship",
    "dwc:resourceID": "dwc:ResourceRelationship",
    "dwc:relatedResourceID": "dwc:ResourceRelationship",
    "dwc:relationshipOfResource": "dwc:ResourceRelationship",
    "dwc:relationshipAccordingTo": "dwc:ResourceRelationship",
    "dwc:relationshipEstablishedDate": "dwc:ResourceRelationship",
    "dwc:relationshipRemarks": "dwc:ResourceRelationship",
    "idigbio:recordId": "dwc:Occurrence",
    "idigbio:isoCountryCode": "dwc:Location",
    "symbiota:recordEnteredBy": "dwc:Occurrence",
    "gbif:canonicalName": "dwc:Taxon",
    # Technically Classe?
    "dwc:MeasurementOrFact": "dwc:MeasurementOrFact",
    "gbif:Reference": "gbif:Reference",
    "gbif:VernacularName": "gbif:VernacularName",
    "dwc:Multimedia": "ac:Multimedia",
}

type_list = dict()

for k in list(sub_types.keys()):
    if sub_types[k][0] not in type_list:
        type_list[sub_types[k][0]] = set()
    type_list[sub_types[k][0]].add(k)

    if k.lower() not in sub_types:
        sub_types[k.lower()] = sub_types[k]
